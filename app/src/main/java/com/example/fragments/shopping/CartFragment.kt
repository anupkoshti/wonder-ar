...
class CartFragment : Fragment(R.layout.fragment_cart) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imgCloseCart.setOnClickListener {
            // Navigate back to the previous destination (home fragment)
            findNavController().navigate(R.id.action_crossbuttontohome)
        }
        ...
        binding.multiArIcon.setOnClickListener {
            val cartProducts = cartAdapter.getCartProducts()
            val models = cartProducts.map { it.product.model }
            val bundle = Bundle().apply {
                putStringArrayList("modelFilenames", ArrayList(models))
            }
            findNavController().navigate(R.id.action_multipleArButton_to_vrFragment, bundle)
        }
